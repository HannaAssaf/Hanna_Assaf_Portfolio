...
export default function About() {
  return (
    <>
      <NextSeo
        title="About Hanna Assaf | Software Developer"
        description="Learn more about Hanna Assaf, a dedicated Software Developer with 2 years of experience. Discover the journey, skills, and passion that drive me to create innovative and user-friendly web solutions."
